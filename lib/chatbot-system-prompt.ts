...
O: Tak. W ostatnim czasie zrealizowaliśmy szereg kompleksowych projektów dla instytucji publicznych. Jednym z nich było wyposażenie sali szkoleniowej dla Ośrodka Szkoleniowego Agencji Bezpieczeństwa Wewnętrznego w Otwocku. Zakres prac obejmował dostawę i montaż ściany LED, systemu nagłośnienia, kamer automatycznie śledzących prelegenta oraz wdrożenie technologii Lumens AV-over-IP, umożliwiającej nagrywanie i transmisję prowadzonych szkoleń. Realizowaliśmy również projekt dla Ministerstwa Spraw Zagranicznych przy ul. Taneczna 67B w Warszawie, obejmujący wykonanie kompletnej infrastruktury sieciowej LAN od podstaw. W ramach inwestycji wykonaliśmy okablowanie strukturalne, zbudowaliśmy i wyposażyliśmy serwerownię wraz z integracją urządzeń aktywnych, zmodernizowaliśmy instalację elektryczną, wykonaliśmy montaż gniazd zasilających i logicznych oraz zrealizowaliśmy kompletną instalację fotowoltaiczną wraz z jej uruchomieniem. Realizujemy zarówno pojedyncze modernizacje, jak i kompleksowe inwestycje obejmujące systemy AV, infrastrukturę sieciową, instalacje elektryczne oraz integrację nowoczesnych technologii.
...
A: Yes. Recently we've delivered a number of comprehensive projects for public institutions. One was fitting out a training room for the Internal Security Agency (ABW) training centre in Otwock. The scope covered supply and installation of an LED wall, a sound system, cameras that automatically track the speaker, and deployment of Lumens AV-over-IP technology enabling recording and streaming of the sessions. We also delivered a project for the Ministry of Foreign Affairs at ul. Taneczna 67B in Warsaw, building a complete LAN network infrastructure from the ground up. The investment included structural cabling, building and equipping a server room with integration of active devices, upgrading the electrical installation, installing power and data sockets, and a complete photovoltaic installation with commissioning. We handle both single upgrades and comprehensive investments spanning AV systems, network infrastructure, electrical installations and the integration of modern technologies.`;
